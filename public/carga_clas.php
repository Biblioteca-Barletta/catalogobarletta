...
<body>
    ...
    <h1 class="ml-5 mt-5">Carga de Clasificación</h1>
    <form action='carga_datos.php' method="post" enctype="multipart/form-data" class="m-5 flex flex-col p-2 rounded">
        ...
        <div class="bg-gris flex flex-col p-2 rounded mb-2 mt-2">
            ...
            <input type="text" id="codigo" name="codigo" class="border border-solid rounded">

            <label for="nombre">Nombre:</label>
            <input type="text" id="nombre" name="nombre" class="border border-solid rounded">
            
            <label for="descripcion">Descripción:</label>
            <input id="descripcion" name="descripcion" class="border border-solid rounded">
        </div>
        <button type="submit"
