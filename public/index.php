...
?>
        ...
        <div class="flex flex-wrap justify-center">
            ...
            <!-- <div class="card m-4 w-fit text-center border rounded bg-gris flex flex-col">
                <h2 class="card-title m-4 text-2xl">Título de la Card</h2>
                <img src="./img/portada.jpg" alt="Imagen de la Card" class="card-image h-52 m-4">
                <button class="card-button bg-azul border border-solid rounded p-2 m-1 text-blanco cursor-pointer"
                    onclick="openModal()">Ver más...</button>
            </div>
        ...
        <div id="modal" class="modal hidden fixed z-20 left-0 top-0 w-full h-full overflow-auto bg-blanco">
            <div class="modal-content relative inset-y-1/4 p-5 border bg-gris">
                <span class="close float-right text-xl font-bold hover:cursor-pointer"
                ...
                <div class="flex">
                    <button
                        class="modal-button block w-full py-2.5 px-5 bg-azul text-blanco rounded cursor-pointer text-base m-2">Reservar
                    </button>
                    <button
                        class="modal-button block w-full py-2.5 px-5 bg-rojo text-blanco rounded cursor-pointer text-base m-2">Devolver
                    </button>
                </div>
            </div>
        </div>
